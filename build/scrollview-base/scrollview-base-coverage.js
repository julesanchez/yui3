...
Y.one(DOCUMENT).on(MOUSEWHEEL, Y.bind(sv._mousewheel, sv));
     ...
     */
    syncUI: function () {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "syncUI", 295);
...
sv._maxScrollY = Math.max(0, scrollHeight - height);
    ...
    scrollTo: function (x, y, duration, easing, node) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "scrollTo", 446);
...
node.transition(transition, callback);
    ...
    _transform: function (x, y) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_transform", 526);
...
return prop;
    ...
    */
    _moveTo : function(node, x, y) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_moveTo", 546);
...
node.setStyle(TOP, y + PX);
    ...
    _onTransEnd: function (e) {
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onTransEnd", 563);
...
sv.fire(EV_SCROLL_END);
    ...
    _onGestureMoveStart: function (e) {
        ...
        _yuitest_coverfunc("build/scrollview-base/scrollview-base.js", "_onGestureMoveStart", 582);
